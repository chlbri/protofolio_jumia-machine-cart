export interface Typegen0 {
    ...
    eventsCausingActions: {
        ...
        updateParent: 'error.platform.payment.started.vouchers.gettingVouchersValue:invocation[0]' | 'error.platform.confirmation:invocation[0]';
        assignVouchersUpdateErrors: 'error.platform.confirmation:invocation[0]';
        inc: 'xstate.init';
        calculateNewTotalWithVouchers: 'PAY.VOUCHER';
        computeVouchers: '';
        calculateRemainVouchers: 'done.invoke.payment.started.processing.paypal:invocation[0]' | 'done.invoke.payment.started.processing.visa:invocation[0]' | 'NEXT' | 'done.invoke.payment.started.processing.orangeMoney:invocation[0]' | 'done.invoke.payment.started.processing.momo:invocation[0]' | 'done.invoke.payment.started.processing.otherPaymentMethod:invocation[0]' | '';
    };
    internalEvents: {
    ...
    missingImplementations: {
        actions: 'assignVouchers' | 'addVouchers' | 'addError_AddingVouchers' | 'setVouchersValues' | 'assignVouchersErrors' | 'updateParent' | 'assignVouchersUpdateErrors' | 'inc' | 'calculateNewTotalWithVouchers' | 'computeVouchers' | 'calculateRemainVouchers';
        services: 'getUserVouchers' | 'addVouchers' | 'getPrefferedPayment' | 'orangemoney' | 'visa' | 'paypal' | 'mtn' | 'otherPaymentMethod' | 'updateVouchers' | 'getVouchersValue';
        guards: 'hasVouchers' | 'isAtReception' | 'isOrangeMoney' | 'isVisa' | 'isPaypal' | 'isMomo' | 'isOther' | 'payZero';
        delays: never;
    };
    eventsCausingServices: {
        ...
        orangemoney: 'done.invoke.payment.started.processing.gettingPrefferedPayment:invocation[0]' | 'PAY.OM';
        visa: 'done.invoke.payment.started.processing.gettingPrefferedPayment:invocation[0]' | 'PAY.VISA';
        paypal: 'done.invoke.payment.started.processing.gettingPrefferedPayment:invocation[0]' | 'PAY.PAYPAL';
        mtn: 'done.invoke.payment.started.processing.gettingPrefferedPayment:invocation[0]' | 'PAY.MOMO';
        otherPaymentMethod: 'done.invoke.payment.started.processing.gettingPrefferedPayment:invocation[0]' | 'PAY.OTHER';
        updateVouchers: 'done.invoke.payment.started.processing.paypal:invocation[0]' | 'done.invoke.payment.started.processing.visa:invocation[0]' | 'NEXT' | 'done.invoke.payment.started.processing.orangeMoney:invocation[0]' | 'done.invoke.payment.started.processing.momo:invocation[0]' | 'done.invoke.payment.started.processing.otherPaymentMethod:invocation[0]' | '';
    ...
    eventsCausingDelays: {};
    matchesStates: 'idle' | 'checkingEnvironmentVariables' | 'started' | 'started.idle' | 'started.gettingUserVouchers' | 'started.ready' | 'started.addingVouchers' | 'started.processing' | 'started.processing.gettingPrefferedPayment' | 'started.processing.unknownPreferences' | 'started.processing.paypal' | 'started.processing.visa' | 'started.processing.atReception' | 'started.processing.orangeMoney' | 'started.processing.momo' | 'started.processing.otherPaymentMethod' | 'started.vouchers' | 'started.vouchers.gettingVouchersValue' | 'started.vouchers.payment' | 'started.vouchers.calculatingNewTotalWithVoucher' | 'started.vouchers.checkingTotal' | 'started.vouchers.vouchers' | 'started.confimation' | 'started.final' | {
        started?: 'idle' | 'gettingUserVouchers' | 'ready' | 'addingVouchers' | 'processing' | 'vouchers' | 'confimation' | 'final' | {
            processing?: 'gettingPrefferedPayment' | 'unknownPreferences' | 'paypal' | 'visa' | 'atReception' | 'orangeMoney' | 'momo' | 'otherPaymentMethod';
            vouchers?: 'gettingVouchersValue' | 'payment' | 'calculatingNewTotalWithVoucher' | 'checkingTotal' | 'vouchers';
        };
    };
    tags: never;
}
